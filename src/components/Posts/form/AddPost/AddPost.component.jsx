    ...
    return (
        <section className="flex flex-col p-10 gap-4 border-slate-900">
            ...
            <form className="flex flex-col items-center gap-4">
                <textarea className="text-xl bg-transparent font-bold w-full text-left" type="text" id="postTitle" name="postTitle" value={title} onChange={onTitleChange} placeholder="Titolo" />
